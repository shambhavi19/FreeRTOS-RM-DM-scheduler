...
#define schedOVERHEAD_ENABLED 1				/* Scheduler overhead parameter. Disable = 0 */
#define schedOVERHEAD_IN_MS	50				/* Scheduler overhead in milliseconds*/

/* Configure scheduling policy by setting this define to the appropriate one. */
#define schedSCHEDULING_POLICY schedSCHEDULING_POLICY_DMS //schedSCHEDULING_POLICY_RMS
